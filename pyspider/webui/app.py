...
class QuitableFlask(Flask):
    ...
    def run(self, host=None, port=None, debug=None, **options):
        ...
        try:
            ...
            dav_app = None
        if dav_app:
            #这里指定由self对象来处理请求 见webui下的py文件 前缀是@app的都是路径映射函数
...
'''
app = QuitableFlask('webui',
                    static_folder=os.path.join(os.getcwd(), 'pyspider', 'webui', 'static'),
                    template_folder=os.path.join(os.getcwd(), 'pyspider', 'webui', 'templates'))        
