...
from sqlalchemy import create_engine, MetaData, Table, Column, String, Float, Text, LargeBinary
...
class ProjectDB(BaseProjectDB):
    ...
    def insert(self, name, obj={}):
        ...
        for o in obj.keys():
            if isinstance(obj[o], unicode):
                obj[o] = obj[o].encode('utf-8')
